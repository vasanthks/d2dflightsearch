...
if(C>=B){return "right now"
}else{if(F<E){return "just a moment ago"
}else{if(F<2*E){return "a minute ago"
}else{if(F<50*E){return AJS.format("{0} minutes ago",Math.floor(F/E))
}else{if(F<90*E){return "about an hour ago"
}else{if(F<24*A){return AJS.format("about {0} hours ago",Math.floor(F/A))
...
try {
/* module-key = 'com.atlassian.mywork.mywork-confluence-host-plugin:mw-miniview', location = 'js/views/miniview/task-views.js' */
var MW=MW||{};
